...
class TextFieldComponent: BaseComponent {
    ...
    private func setupConstraints(view: UIView) {
        ...
        view.addConstraint(NSLayoutConstraint(item: textField, attribute: .top, relatedBy: .equal, toItem: view, attribute: .top, multiplier: kTextFieldComponentDefaultMultiplierConstraint, constant: kTextFieldComponentTopConstraint))
        view.addConstraint(NSLayoutConstraint(item: textField, attribute: .leading, relatedBy: .equal, toItem: view, attribute: .leading, multiplier: kTextFieldComponentDefaultMultiplierConstraint, constant: kTextFieldComponentLeadingConstraint))
        view.addConstraint(NSLayoutConstraint(item: textField, attribute: .trailing, relatedBy: .equal, toItem: view, attribute: .trailing, multiplier: kTextFieldComponentDefaultMultiplierConstraint, constant: kTextFieldComponentTrailingConstraint))
        view.addConstraint(NSLayoutConstraint(item: textField, attribute: .height, relatedBy: .equal, toItem: view, attribute: .height, multiplier: kTextFieldComponentDefaultMultiplierConstraint, constant: kTextFieldComponentHeightConstraint))
