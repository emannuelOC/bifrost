...
class ButtonComponent: BaseComponent {
    ...
    override func applyViewsFromJson(dynamicComponent: DynamicComponent, actionDelegate: DynamicActionDelegate) throws -> UIView {
            ...
            self.button.titleEdgeInsets = UIEdgeInsets.init(top: kButtonComponentTitleInsetTop, left: kButtonComponentTitleInsetLeft, bottom: kButtonComponentTitleInsetBottom, right: kButtonComponentTitleInsetRight)
    ...
    private func setupConstraints(view: UIView) {
        ...
        view.addConstraint(NSLayoutConstraint(item: button, attribute: .top, relatedBy: .equal, toItem: view, attribute: .top, multiplier: kButtonComponentDefaultMultiplierConstraint, constant: kButtonComponentTopConstraint))
        view.addConstraint(NSLayoutConstraint(item: button, attribute: .leading, relatedBy: .equal, toItem: view, attribute: .leading, multiplier: kButtonComponentDefaultMultiplierConstraint, constant: kButtonComponentLeadingConstraint))
        view.addConstraint(NSLayoutConstraint(item: button, attribute: .trailing, relatedBy: .equal, toItem: view, attribute: .trailing, multiplier: kButtonComponentDefaultMultiplierConstraint, constant: kButtonComponentTrailingConstraint))
        view.addConstraint(NSLayoutConstraint(item: button, attribute: .height, relatedBy: .equal, toItem: view, attribute: .height, multiplier: kButtonComponentDefaultMultiplierConstraint, constant: kButtonComponentHeightConstraint))
    }
